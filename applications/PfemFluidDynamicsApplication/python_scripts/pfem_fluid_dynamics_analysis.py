...
class PfemFluidDynamicsAnalysis(AnalysisStage):
    ...
    def Initialize(self):
        ...
        self.calculate_wave_first_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 1.9, 1.75, 0, 2.5e-1, "WaveHeightProbe1",0.1)
        self.calculate_wave_second_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 3.1, 1.75, 0, 2.5e-1, "WaveHeightProbe2",0.1)
        self.calculate_wave_third_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 6, 1.75, 0, 2.5e-1, "WaveHeightProbe3",0.1)
        self.calculate_wave_quarter_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 8.8, 1.75, 0, 2.5e-1, "WaveHeightProbe4",0.1)
        self.calculate_wave_fifth_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 11.3, 1.75, 0, 2.5e-1, "WaveHeightProbe5",0.1)
        self.calculate_wave_sixth_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 16.8, 1.75, 0, 2.5e-1, "WaveHeightProbe6",0.1)
        self.calculate_wave_seventh_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 22, 1.75, 0, 2.5e-1, "WaveHeightProbe7",0.1)
        self.calculate_wave_eighth_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 26.6, 1.75, 0, 2.5e-1, "WaveHeightProbe8",0.1)
        self.calculate_wave_ninth_probe = KratosMultiphysics.PfemFluidDynamicsApplication.CalculateWaveHeightProcess(self.main_model_part,0,1,2, 32.5, 1.75, 0, 2.5e-1, "WaveHeightProbe9",0.1)
    ...
    def FinalizeSolutionStep(self):
        ...
        self.calculate_wave_third_probe.Execute()
        self.calculate_wave_quarter_probe.Execute()
        self.calculate_wave_fifth_probe.Execute()
        self.calculate_wave_sixth_probe.Execute()
        self.calculate_wave_seventh_probe.Execute()
        self.calculate_wave_eighth_probe.Execute()
        self.calculate_wave_ninth_probe.Execute()
