...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(DELTA_S)
    KRATOS_REGISTER_VARIABLE(G_COEFFICIENT_S)
    KRATOS_REGISTER_VARIABLE(RAYLEIGH_ALPHA_1_S)
    KRATOS_REGISTER_VARIABLE(RAYLEIGH_BETA_1_S)
    KRATOS_REGISTER_VARIABLE(EPSILON_S)
    KRATOS_REGISTER_VARIABLE(THETA_S)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_OLD_S)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_OLDER_S)
