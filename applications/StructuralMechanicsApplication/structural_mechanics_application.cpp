...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(DELTA_2)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_INTERNAL_FORCE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_DAMPING_FORCE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_EXTERNAL_FORCE)
