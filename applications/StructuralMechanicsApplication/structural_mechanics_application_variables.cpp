...
KRATOS_CREATE_VARIABLE(double, DELTA_2)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_INTERNAL_FORCE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_DAMPING_FORCE)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DELTA_2_EXTERNAL_FORCE)
