...
KRATOS_CREATE_VARIABLE(double, DELTA_S)
KRATOS_CREATE_VARIABLE(double, G_COEFFICIENT_S)
KRATOS_CREATE_VARIABLE(double, RAYLEIGH_ALPHA_1_S)
KRATOS_CREATE_VARIABLE(double, RAYLEIGH_BETA_1_S)
KRATOS_CREATE_VARIABLE(double, EPSILON_S)
KRATOS_CREATE_VARIABLE(double, THETA_S)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_OLD_S)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISPLACEMENT_OLDER_S)
