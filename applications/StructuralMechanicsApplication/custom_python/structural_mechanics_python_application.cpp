...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DELTA_S )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, G_COEFFICIENT_S )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RAYLEIGH_ALPHA_1_S )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RAYLEIGH_BETA_1_S )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EPSILON_S )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THETA_S )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,  DISPLACEMENT_OLD_S )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,  DISPLACEMENT_OLDER_S )
