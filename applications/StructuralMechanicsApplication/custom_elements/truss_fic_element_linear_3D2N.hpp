...
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) TrussFICElementLinear3D2N : public TrussElementLinear3D2N
{
public:
...
protected:
    ...
    void CalculateFrequencyMatrix(MatrixType& rMatrix, const ProcessInfo& rCurrentProcessInfo);
