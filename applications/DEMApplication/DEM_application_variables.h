...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, NODAL_DAMPING)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, ROTATIONAL_NODAL_DAMPING)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, NODAL_STIFFNESS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, ROTATIONAL_NODAL_STIFFNESS)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, EXTERNAL_FORCES)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ROTATIONAL_EXTERNAL_FORCES)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, INTERNAL_FORCES)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ROTATIONAL_INTERNAL_FORCES)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, INTERNAL_FORCES_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ROTATIONAL_INTERNAL_FORCES_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, AUX_IMPULSE)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ROTATIONAL_AUX_IMPULSE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, ALPHA_RAYLEIGH)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BETA_RAYLEIGH)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, THETA_1)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, THETA_2)
