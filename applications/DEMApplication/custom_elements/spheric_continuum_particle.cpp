...
// void SphericContinuumParticle::ComputeBallToBallStiffnessAndDamping(SphericParticle::ParticleDataBuffer & data_buffer,
...
// void SphericContinuumParticle::ComputeBallToRigidFaceStiffnessAndDamping(SphericParticle::ParticleDataBuffer & data_buffer,
//                                                                                 double& r_nodal_stiffness,
//                                                                                 double& r_nodal_damping,
//                                                                                 double& r_nodal_rotational_stiffness,
//                                                                                 double& r_nodal_rotational_damping)
...
// double SphericContinuumParticle::CalculateStiffnessNorm(const double& r_normal_stiffness, const double& r_tangential_stiffness) {
//     // TODO: this is for 2D! Just provisional
//     // return std::sqrt(r_normal_stiffness*r_normal_stiffness+2.0*r_tangential_stiffness*r_tangential_stiffness);
//     return std::sqrt(r_normal_stiffness*r_normal_stiffness+1.0*r_tangential_stiffness*r_tangential_stiffness);
// }

// double SphericContinuumParticle::CalculateDampingNorm(const double& r_normal_damping_coeff, const double& r_tangential_damping_coeff) {
//     // TODO: this is for 2D! Just provisional
//     // return std::sqrt(r_normal_damping_coeff*r_normal_damping_coeff+2.0*r_tangential_damping_coeff*r_tangential_damping_coeff);
//     return std::sqrt(r_normal_damping_coeff*r_normal_damping_coeff+1.0*r_tangential_damping_coeff*r_tangential_damping_coeff);
// }
