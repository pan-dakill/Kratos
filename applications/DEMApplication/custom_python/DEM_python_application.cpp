...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_DAMPING)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROTATIONAL_NODAL_DAMPING)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_STIFFNESS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROTATIONAL_NODAL_STIFFNESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, EXTERNAL_FORCES)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ROTATIONAL_EXTERNAL_FORCES)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, INTERNAL_FORCES)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ROTATIONAL_INTERNAL_FORCES)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, INTERNAL_FORCES_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ROTATIONAL_INTERNAL_FORCES_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, AUX_IMPULSE)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ROTATIONAL_AUX_IMPULSE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ALPHA_RAYLEIGH)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BETA_RAYLEIGH)
