...
void KratosPoromechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE( DELTA1 )
    KRATOS_REGISTER_VARIABLE( DELTA2 )
    KRATOS_REGISTER_VARIABLE( FIC_GAMMA )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA1_DAMPING_D_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA1_INTERNAL_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA1_EXTERNAL_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA2_DAMPING_D_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA2_INTERNAL_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA2_EXTERNAL_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DAMPING_D_FORCE )
