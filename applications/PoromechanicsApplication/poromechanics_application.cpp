...
void KratosPoromechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE( G_FACTOR )
    KRATOS_REGISTER_VARIABLE( DELTA )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_DAMPING_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_INTERNAL_FORCE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_EXTERNAL_FORCE )
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_DISPLACEMENT_F )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_DISPLACEMENT_LF )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_DISPLACEMENT_P )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_VELOCITY_F )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_VELOCITY_LF )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_VELOCITY_P )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_ACCELERATION_F )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_ACCELERATION_LF )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DELTA_ACCELERATION_P )
    KRATOS_REGISTER_VARIABLE( DELTA_WATER_PRESSURE_F )
    KRATOS_REGISTER_VARIABLE( DELTA_WATER_PRESSURE_LF )
    KRATOS_REGISTER_VARIABLE( DELTA_WATER_PRESSURE_P )
    KRATOS_REGISTER_VARIABLE( DELTA_DT_WATER_PRESSURE_F )
    KRATOS_REGISTER_VARIABLE( DELTA_DT_WATER_PRESSURE_LF )
    KRATOS_REGISTER_VARIABLE( DELTA_DT_WATER_PRESSURE_P )
}
