...
KRATOS_CREATE_VARIABLE( double, G_FACTOR )
KRATOS_CREATE_VARIABLE( double, DELTA1 )
KRATOS_CREATE_VARIABLE( double, DELTA2 )
KRATOS_CREATE_VARIABLE( double, FIC_GAMMA )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA1_DAMPING_D_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA1_INTERNAL_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA1_EXTERNAL_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA2_DAMPING_D_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA2_INTERNAL_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DELTA2_EXTERNAL_FORCE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( DAMPING_D_FORCE )
