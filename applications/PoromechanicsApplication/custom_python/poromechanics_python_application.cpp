...
PYBIND11_MODULE(KratosPoromechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, DELTA1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, DELTA2 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, FIC_GAMMA )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA1_DAMPING_D_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA1_INTERNAL_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA1_EXTERNAL_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA2_DAMPING_D_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA2_INTERNAL_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DELTA2_EXTERNAL_FORCE )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, DAMPING_D_FORCE )
